...
public class DatabaseHelper extends SQLiteOpenHelper {
    private static final String TABLE_STUDENTS = "";
    public static String DATABASE_NAME="student_db";
    private static final int DATABASE_VERSION=1;
    private static final String TABEL_STUDENTS="students";
    private static final String KEY_ID="id";
    private static final String KEY_NAMA="nama";
    private static final String KEY_ALAMAT="alamat";
    private static final String CREAATE_TABLE_STUDENTS=
            "CREATE TABLE "+TABEL_STUDENTS
                    +"("+KEY_ID
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        sqLiteDatabase .execSQL(CREAATE_TABLE_STUDENTS);

    }

    @Override
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int i, int i1) {
        sqLiteDatabase.execSQL("DROP TABLE IF EXISTS '"+TABEL_STUDENTS+"'");
    }
    ...
    public long addStudent(String nama,String alamat){
        ...
        long insert=db.insert(TABEL_STUDENTS,null,values);
        return insert;
    }
    ...
    public ArrayList<Map<String,String>> getAllStudents(){
        ...
        String alamat="";
        int id=0;
        String selectQuery="SELECT * FROM "+TABEL_STUDENTS;
        SQLiteDatabase db=this.getWritableDatabase();
